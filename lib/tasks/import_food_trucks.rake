task import_food_trucks: :environment do
  ...
  food_truck_names_and_images = [
    ...
    {name:'Taco Choi', type: 'Mexican', image_url: 'https://images.gotruckster.com/foodtruck/cover_photos/3GcYVi6WsJOs12nA73X86J4TNqwmGeqGl4MwLo6b.jpeg' , name:'Taco Choi'},
